...
#ifndef INCLUDE__VT3_POU__RESETBUFFERCOM_H
#define INCLUDE__VT3_POU__RESETBUFFERCOM_H
...
void resetBufferCOM__init(void);

/* prototype for the function that contains the POU body */
void resetBufferCOM__call(void);




#endif /* INCLUDE__VT3_POU__RESETBUFFERCOM_H */
