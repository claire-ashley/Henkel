 ...
 * comment:      
 */
#define vToleranceInd (*(BOOL FARPTR)(&BYTEM[11]))
 ...
 * comment:      
 */
#define vStartUpCounter (*(INT FARPTR)(&BYTEM[14]))
 ...
 * comment:      
 */
#define degreeLong (*(INT FARPTR)(&BYTEM[16]))
 ...
 * comment:      
 */
#define degreeLat (*(INT FARPTR)(&BYTEM[18]))
