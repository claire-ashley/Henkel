...
static void MAIN__core(void)
{
	...
	//Angle Conversions
	degreeLong = AGL_longitudinal; //x-axis
	degreeLat = AGL_lateral; //y-axis
	
	//Tolerance range indicator
	if ((degreeLong >= -1) && (degreeLong <= 1) && (degreeLat >= -1) && (degreeLat <= 1))
	{
	    vToleranceInd = 1; //green 
	}
	
	else if ((degreeLong >= -1) && (degreeLong <= 1) && (degreeLat >= 899) && (degreeLat <= 901))
	{
	    vToleranceInd = 1; //green 
	}
	else 
