...
{
	static const STRING(6) FAR _str = { 6, 6, "A-AXIS" };
...
void vt3_event_ind_Main_simple_text_2(
	...
	vt3_indicator_SimpleText FARPTR ind)
{
	static const STRING(6) FAR _str = { 6, 6, "C-AXIS" };
	ind->currentValue = (PSTRING)&_str;
...
{
	ind->currentValue = ((vToleranceInd));

	/* Warning: the code below is generated by vt3.
	 * If you wish to make changes, please use vt3.
	 * 
	 *  node is:    /project/CANVIEW4/Screens/Main/multibitmap
	 * 
	 * Omitted: the list of replaced identifiers is very long
	 */
	{
	...
	vt3_indicator_MultiBitmap FARPTR ind)
{
	 ...
	 * If you wish to make changes, please use vt3.
	 * 
	 *  node is:    /project/CANVIEW4/Screens/Main/multibitmap_2
	 * 
	 * Omitted: the list of replaced identifiers is very long
	 */
	{
