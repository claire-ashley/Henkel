...
/* timer event handler for indicator: /project/CANVIEW4/Screens/Main/multibitmap 
 * runs every 200ms
 */
void vt3_event_ind_Main_multibitmap(
	BYTE event, 
	vt3_indicator_MultiBitmap FARPTR ind)
;

/* timer event handler for indicator: /project/CANVIEW4/Screens/Main/multibitmap_2 
 * runs every 200ms
 */
void vt3_event_ind_Main_multibitmap_2(
	BYTE event, 
	vt3_indicator_MultiBitmap FARPTR ind)
;
